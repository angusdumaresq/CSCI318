...
public class Customer {
    ...
    public void setCustomer (Customer customer) {
        ...
        if (customer.contact != null) {
            ...
            if(this.contact == null) {
                this.contact = new Contact(); contact.setId(id); }

            this.contact.setContact(customer.contact);
        }
    }
